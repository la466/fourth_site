...
# Script number:				1.2
# File:							2 of 2
# Prerequisite script(s):		1.1
# Prerequisite file(s):		 	N/A
# Description: 					Move the contents of the downloaded bacterial genomes to a single folder
...
downloads_path = current_directory + "/bacterial_genomes/"

# Define the folder to hold the genomes
genome_folder_directory = downloads_path + "/bacteria_raw_embl/"
