...
# Description: 				Calculate the distance to the third out of frame stop codon for genomes comparing A/not A
# Output file(s):			_stopDistanceGenomeThirdStop.csv, _stopDistanceTable4GenomeThirdStop.csv
...
def newFile():
	...
	stopDistanceDistFile = stop_directory + "_stopDistanceGenomeThirdStop.csv"
	stopDistanceDist = open(stopDistanceDistFile, "w")


	stopDistanceTable4DistributionFile = stop_directory + "_stopDistanceTable4GenomeThirdStop.csv"
