...
# Script number: 			13.2
# File: 					2 of 3
# Prerequisite script(s):	1.1, 1.2, 2.1, 3.1, 3.2, 13.1
# Prerequisite file(s):		_antiSDseqeunces.txt, filteredGenes.csv, table4genomes.txt
# Description: 				Determine Shine Dalgarno sequences using free2bind
# Output file(s):			
...
def main():
	...
	GC3s, Aratios = get_genome_info(fourthPath)
